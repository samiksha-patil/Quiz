...
urlpatterns = [
    ...
    path('student/quiz/<int:pk>/', views.take_quiz, name='take_quiz'),
    path('student/quiz/<int:pk>/result', views.result, name='result'),
    path('student/dashboard', views.TakenQuizListView, name='dashboard'),
]
